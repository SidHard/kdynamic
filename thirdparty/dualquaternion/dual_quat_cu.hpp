...
class Dual_quat_cu {
    ...
    inline __host__ __device__ Dual_quat_cu()
    {
    ...
    /// and dual part
    inline __host__ __device__ Dual_quat_cu(const Quat_cu& q0, const Quat_cu& qe)
    {
        _quat_0 = q0;
        _quat_e = qe;
    }
    ...
    inline __host__ __device__ Dual_quat_cu(const Quat_cu& q, const Vec3& t)
    {
    ...
    inline __host__ __device__ Dual_quat_cu(const Transfo& t)
    {
        Quat_cu q(t);
    ...
    inline __host__ __device__ Point3 transform(const Point3& p ) const
    {
    ...
    inline __host__ __device__ Vec3 rotate(const Vec3& v) const
    {
        Quat_cu tmp = _quat_0;
        tmp.normalize();
        return tmp.rotate(v);
    ...
    inline __host__ __device__ Dual_quat_cu dual_quat_from(const Quat_cu& q, const Vec3& t) const
    {
    ...
    inline __host__ __device__ Transfo to_transformation()
    {
        Vec3 t;
        float norm = _quat_0.norm();
    ...
    inline __host__ __device__ Dual_quat_cu operator+(const Dual_quat_cu& dq) const
    {
        return Dual_quat_cu(_quat_0 + dq._quat_0, _quat_e + dq._quat_e);
    }

    inline __host__ __device__ Dual_quat_cu operator*(float scalar) const
    {
        return Dual_quat_cu(_quat_0 * scalar, _quat_e * scalar);
    }

    /// Return a dual quaternion with no translation and no rotation
    inline __host__ __device__ static Dual_quat_cu identity()
    {
    ...
    inline __host__ __device__ Quat_cu get_dual_part() const { return _quat_e; }

    inline __host__ __device__ Quat_cu get_non_dual_part() const { return _quat_0; }

    inline __host__ __device__ Quat_cu translation() const { return _quat_e; }

    inline __host__ __device__ Quat_cu rotation() const { return _quat_0; }

    inline __host__ __device__ void set_rotation( const Quat_cu& q ){ _quat_0 = q; }
